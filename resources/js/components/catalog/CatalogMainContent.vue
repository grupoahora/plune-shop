...
<template>
    <section class="flex-1">
        <div class="mb-8 flex flex-col gap-4 xl:flex-row xl:items-end xl:justify-between">
            ...
            <Button class="flex items-center gap-2" type="button" variant="outline">
        ...
        <div v-else class="rounded-2xl border border-dashed border-border px-6 py-12 text-center">
            ...
            <Link class="mt-4 inline-flex text-sm font-semibold text-primary" href="/catalogo">
                Limpiar búsqueda
            </Link>
        </div>
        ...
        <div class="mt-16 flex items-center justify-center gap-4">
            ...
            <span class="rounded-xl bg-primary px-4 py-2 font-bold text-foreground">1</span>
            <span class="cursor-pointer rounded-xl px-4 py-2 font-bold hover:bg-white dark:hover:bg-white/5">2</span>
            <span class="cursor-pointer rounded-xl px-4 py-2 font-bold hover:bg-white dark:hover:bg-white/5">3</span>
            <Button size="icon" type="button" variant="outline">
